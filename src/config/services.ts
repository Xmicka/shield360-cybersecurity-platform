...
export interface ModuleConfig {
    ...
    description: string;
    deployedUrl: string;
    internalRoute: string; // Internal react-router path (used when module is integrated)
    repoUrl: string;
...
export const MODULES: ModuleConfig[] = [
    {
        ...
        internalRoute: "/dashboard/endpoint-scanner",
        repoUrl: "",
        tier: "free",
    ...
    },
    {
        ...
        internalRoute: "/dashboard/shadow-it",
    ...
    },
    {
        ...
        internalRoute: "/dashboard/compliance-assistant",
    ...
    },
    {
        ...
        internalRoute: "/dashboard/spear-phishing",
...
export const PLANS: PlanConfig[] = [
    ...
    },
    {
        ...
        moduleLimits: {
            "endpoint-scanner": 50,
            "shadow-it": 50,
            "compliance-assistant": 20,
            "spear-phishing": 20,
        },
        features: [
            "Everything in Starter, plus:",
            "Endpoint Scanner: 50 scans/mo",
            "Shadow IT: 50 scans/mo",
            "Compliance Assistant: 20 audits/mo",
            "Spear Phishing Sim: 20 campaigns/mo",
            "Admin control panel",
